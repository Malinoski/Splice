...
import org.openehr.rm.util.SPLiCEUtils;
...
public class SkeletonGeneratorTestBase extends TestCase {
    ...
    protected void loadArchetypeMap() throws Exception {
        ...
        //final File folder = new File("src/main/resources/"+ARCHETYPE_PATH);
//        final File folder = new File(ARCHETYPE_PATH);
//        String[] ids = new SPLiCEUtils().getVectorFilesWithoutExtensionFromFolder(folder);
    ...
    public Object instancemin, instancemaxem; // teste Vinicius
}
